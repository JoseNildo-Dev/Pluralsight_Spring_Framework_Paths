package br.com.josenildo.conferenceapp.config;
...
public class ConferenceConfiguration implements WebMvcConfigurer {
    ...
    public ViewResolver viewResolver() { 
        ...
        bean.setSuffix(".jsp");
        // Lower order than thymeleaf, so thymeleaf resolver will pull the pages up first
        // Both jsp and thymeleaf could be configured if needed, this breaks jsp pages
        bean.setOrder(1); 
        return bean;
    }
